...
new_model = keras.models.load_model('step1_BATCH100epoch10LSTM10.h5')
new_model.summary()
...
for i in range(data_length):
    input_x.append(test_x_sig[i+500:i+time_step+500])
    target_y.append(test_y_sig[i+time_step+500])
